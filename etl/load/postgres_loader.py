...
class PostgresLoader(BaseLoader):
        ...
        try:
            ...
            upsert_query = """
                INSERT INTO listings (
                    ...
                    price, currency, rooms, bathrooms, parkings, area_m2,
    ...
    def _transform_announcement_to_listing(self, announcement: Dict) -> Dict:
        ...
        return {
            ...
            'city': announcement.get('city_name', ''),
            ...
            'parkings': announcement.get('parkings', 0) if isinstance(announcement.get('parkings'), int) else 0,
